                ...
                <div className="mb-6 sm:mb-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                    ...
                    <div className="relative bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-4 sm:p-6 shadow-xl opacity-60 border-2 border-slate-600">
                      ...
                      <h3 className="text-xl sm:text-2xl font-bold text-slate-300 mb-1 sm:mb-2">Slots</h3>
                      <p className="text-slate-400 text-xs sm:text-sm mb-3 sm:mb-4">Spin to win big prizes!</p>
                      <div className="flex justify-between items-center">
