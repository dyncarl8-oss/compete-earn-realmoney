...
export default function GameEndScreen({ gameId }: GameEndScreenProps) {
  ...
  const sortedPlayers = [...finalResults.players].sort((a, b) => a.rank - b.rank);
        ...
        <Card className="bg-slate-800/50 border-slate-700">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-red-400">-${parseFloat(myResult.entryFee).toFixed(2)}</div>
